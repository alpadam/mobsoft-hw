...
import hu.bme.aut.mobsoft.lab.mobszofthomework.network.FuelRecordApi;
...
public class MockNetworkModule {
    ...
    @Provides
    @Singleton
    public FuelRecordApi provideFuelRecordApi(Retrofit retrofit) {
        return networkModule.provideAFuelRecordApi(retrofit);
    }
}
